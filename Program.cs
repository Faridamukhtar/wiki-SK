                      ...
                      <div class="uk-navbar-right">
                        <div class="uk-navbar-item">
                          <form action="/new-page">
                            <input class="uk-input uk-form-width-medium" type="text" name="pageName" placeholder="Type desired page title here">
                            <input type="submit"  class="uk-button uk-button-default" value="Add">
                          </form>
                        </div>
                      </div>
                    </div>
